...
<head>
	...
	width:200px;
       ...
       .img4{
		...
		.section-wrap .section-1{ background-color:#2a4cd}
...
<body background="img/phone2.png">
	<section class="section-wrap">
		...
		<td class="td">
		<strong>欢迎！/<a href="demo.html">退出</a></strong>
		</td>
		...
		<div class="section section-2">
			<div class="title">
				<p class="tit"><strong>全球震撼首发：iphone GYH!</strong></p>
			</div>
			<div id="img-left">
			<img alt="" src="img/front.png">
		    </div>
		    <div id="img-right">
			<img alt="" src="img/back.png">
		    </div>
		    <div id="img-buttom">
			<a href="index.html" target="_blank"><img alt="" src="img/text.png">
		    </a></div> 
		</div>
		<div class="section section-3">
		
			<div class="title">
				<p class="tit">最新手机概览</p>
			</div>
			<div id="table1">
			<table border=1>
			<tr id="tr1">
			<td class="td2"><img alt="" src="img/iphone.jpg" width="280px" height="400px"></td>
			</tr>
			<tr>
			...
			<table border=1>
			<tr id="tr2">
			<td class="td2"><img alt="" src="img/vivo.jpg" width="280px" height="400px"></td>
			</tr>
			<tr>
			<td style="font-size:30px;text-align:center;">
			Vivo
			...
			<table border=1>
			<tr id="tr3">
			<td class="td3"><img alt="" src="img/xiaomi.jpg" width="280px" height="400px"></td>
			</tr>
			<tr>
			<td style="font-size:30px;text-align:center;">
			Mi
			...
			<table border=1>
			<tr id="tr4">
			<td class="td4"><img alt="" src="img/huawei1.jpg" width="280px" height="400px"></td>
			</tr>
			<tr>
			<td style="font-size:30px;text-align:center;">
			Hua Wei
		...
		<div class="section section-4">
			...
			<div><img class="img3" src="img/pinglun.png"></div>
			<div><img class="img4" src="img/pingjia.png"></div>
			<div id="form3"><form id="comment" action="edit.php" method="post">
<p>name:<input id="input3" type="text" name="username" /></p>
<p>comment:<textarea id="textarea" cols="30" rows="5" name="comment" /></textarea></p>
<input id="button3" class="btn btn-light" type="submit" value="submit"/>
</form>
...
-->
		...
		<div class="section section-5">
			<div class="title">
				<p class="tit">Made by Guo Yihao</p>
				<p class="tit">Thank You！</p>
			</div>
			<div><img src="img/china.png"></div>
		</div>
	</section>
